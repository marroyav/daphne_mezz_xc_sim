...
def main():
    ...
    ap.add_argument("--out-bin", default="sample_waveform.bin", help="Output binary file (uint16 LE).")
    ap.add_argument("--out-txt", default="sample_waveform.txt", help="Output text file (one sample per line).")
